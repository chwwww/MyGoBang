...
public class ChessBoard extends JPanel implements MouseListener {  
   ...
   Point[] chessList=new Point[ROWS*COLS];//初始每个数组元素为null 
   int[][] chess=new int[ROWS][COLS];//初始每个数组元素为null 1=黑， 2=白
...
//绘制  
   ...
   public void mousePressed(MouseEvent e){//鼠标在组件上按下时调用  
       ...
       //isBlack=!isBlack;
       /*在这里调用AI的方法首先遍历找到合法落子点其次给每个位置攻防打分取得分最高的下如果一样取最靠近里面的下，之后调用isWin*/
